...
export default function Footer() {
    return (
        <>
            <footer className="bg-body-tertiary text-center mb-0">
                {/* Grid container */}
                <div className="container p-4 pb-0">
                    {/* Section: Social media */}
                    <section className="mb-4">
                        {/* Facebook */}
                        <a data-mdb-ripple-init className="btn text-white btn-floating m-1" style={{ backgroundColor: '#3b5998' }} href="https://www.facebook.com" role="button"><i className="fab fa-facebook-f" /></a>
                        {/* Twitter */}
                        ...
                        {/* Github */}
                        <a data-mdb-ripple-init className="btn text-white btn-floating m-1" style={{ backgroundColor: '#333333' }} href="https://github.com/ahmed824" role="button"><i className="fab fa-github" /></a>
                    </section>
                    {/* Section: Social media */}
                </div>
                {/* Grid container */}
                ...
                <div className="text-center p-3" style={{ backgroundColor: 'rgba(0, 0, 0, 0.05)' }}>
                    © 2024 Copyright:
                    <a className="text-body" href="https://mdbootstrap.com/"> FreshCart.com</a>
                </div>
                {/* Copyright */}
            </footer>
